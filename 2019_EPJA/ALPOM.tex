...
% \includegraphics{gepgmp_allpol_final_lin_lin.pdf}
 %}
 \hspace*{-2truecm}
 \includegraphics[width=1\columnwidth,angle=90]{gepgmp_allpol_final_lin_lin.pdf}
...
\begin{figure}
\centering
\includegraphics[width=1\columnwidth]{gengmn.pdf}
...
\begin{figure}
\begin{centering}
\includegraphics[width=1\columnwidth]{A_Y_Comb1a.pdf} 
\par\end{centering}
...
\begin{figure*}
\centering
\includegraphics[width=0.45\textwidth]{Cal_375_CH2left.eps}
\includegraphics[width=0.45\textwidth]{Cal_60_CH2right.eps}
\hspace*{-0.1cm}
